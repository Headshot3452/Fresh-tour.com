...
class MenuController extends ModuleController
{
    ...
    public function getLeftMenu()
    {
        ...
        return array_merge(
            array(array('text' => CHtml::link('<img class="root-folder-orange" src="/images/icon-admin/folder-orange.png">'.Yii::t('app','Create root category'),array('update')),'children'=>array())
