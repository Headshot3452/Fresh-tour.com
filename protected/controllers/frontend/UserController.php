<?php
    class UserController extends FrontendController
    {
        ...
        public function actionHslogin()
        {
            ...
            if(isset($_POST['Users']) || Yii::app()->user->getState('post_users'))
            {
                if(isset($_POST['Users']))
                {
                    Yii::app()->user->setState('post_users', $_POST['Users']);
                    $post = $_POST['Users'];
                }
                else
                {
                    $post = Yii::app()->user->getState('post_users');
                    Yii::app()->user->setState('post_users', null);
                }
                ...
                if ($model->validate())
                {
                    ...
                    $Users->last_ip = Yii::app()->getRequest()->getUserHostAddress();
