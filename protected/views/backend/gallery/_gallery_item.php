...
<div class="gallery_list">
    ...
    $header .= '<div class="btn-group checkbox">
            ...
            ';
    $header .= '<a data-placement="bottom" title="Добавить товар" href="' . $this->createUrl('create_product') . '?tree_id=' . $category_id . '" class="btn btn-action"><i class="fa fa-plus"></i><i class="fa fa-camera"></i></a>';
    $header .= '</div>';
