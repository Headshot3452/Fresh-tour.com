...
<?php $form=$this->beginWidget('BsActiveForm', array(
	...
	<div class="form-group row date-info">
        ...
        <div class="col-xs-5 col-xs-offset-4 user-info">
            ...
            <?php echo $form->textField($model,'author_id', array('readonly'=>true, 'value'=>$model->author->login)); ?>
            <input type="hidden" name="author_id" value="<?php echo $model->author_id; ?>">
        ...
        <div class="col-xs-5 col-xs-offset-4 user-info">
            <div class="label-block"><?php echo $form->labelEx($model,'author_id'); ?>:</div>
            <?php echo $form->textField($model,'author_id', array('readonly'=>true, 'value'=>Users::model()->findByPk(Yii::app()->user->id)->login)); ?>
        </div>
        <?php endif; ?>
    </div>
