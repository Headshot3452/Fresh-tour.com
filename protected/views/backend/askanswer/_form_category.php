...
//                                            if (response["success"])
//                                            {
//                                                $(".images .thumbnails").append("<li class=\"col-xs-2 image\"><input type=\"hidden\" name=\"'.get_class($model).'['.$model->getFilesAttrName().'][]\" value=\""+response["folder"]+response["filename"]+"\"><img src=\"/"+response["folder"]+response["filename"]+"\" width=\"140\"/><i class=\"glyphicon glyphicon-remove\"></i></li>")
//                                            }
//                                        }',
//                    ),
//                    'validation' => array(
...
//            for ($i=0; $i<$count; $i++)
//            {
//                echo '<li class="col-xs-2 image">'.$model->gridImage($images[$i]['path'],'').
...
?>
    ...
    <div class="form-group"><div class="seo-title"><?php echo Yii::t('app','Seo tags'); ?></div></div>
        ...
        <div class="form-group seo-text">
            ...
            <span>Осталось символов: 250</span>
        </div>
