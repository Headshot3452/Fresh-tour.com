<div class="review_list items">
    ...
    $title='<div class="title col-xs-3">Список отзывов темы</div>
    ...
    $table =
        ...
        .'</div>
            ...
            <div class="list-title row">
                ...
                <div class="col-xs-2 no-padding">Клиент</div>
                <div class="col-xs-2">Тема</div>
                <div class="col-xs-7">Вопрос</div>
            </div>
        <div class="row">
            <ul id="table-review">';
    $typeCatalog = 'small';
...
$archive = $status!=ReviewItem::STATUS_ARCHIVE?"<a href='?status=".ReviewItem::STATUS_ARCHIVE."' class='btn btn-gray archive'>Архив</a>":'';
