<?php
    ...
    $header .= '<a data-placement="bottom" title="Копировать товар" href="#modal_copy_products" role="button" data-toggle="modal" class="btn btn-action copy_products"><span class="icon-admin-copy-product"></span></a>';
    $header .= '<a data-placement="bottom" title="Переместить товар" href="#modal_copy_products" role="button" data-toggle="modal" class="btn btn-action move_products"><span class="icon-admin-move-product"></span></a>';
    $header .= '</div>';
