...
//echo '<a href="'.$this->createUrl('copy_product').'" class="btn btn-small"><span class="icon-admin-copy-document"></span></a>';
//echo '<a href="'.$this->createUrl('create_product').'?tree_id='.$category_id.'" class="btn btn-small"><span class="icon-admin-add-document"></span></a>';
////echo BsHtml::link(Yii::t('app','New product'),array('create_product','tree_id'=>$category_id),array('class'=>'icon-admin-add-document'));
//echo '<pre>';
//print_r($model->language($this->getCurrentLanguage()->id)->search()->getData());
//echo '</pre>';
