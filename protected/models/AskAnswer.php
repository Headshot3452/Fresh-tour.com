...
class AskAnswer extends Model
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, language_id, seo_title, seo_keywords, seo_description, answer_ok, title, name, time, preview, text, images, create_time, update_time, author_id, status', 'safe', 'on'=>'search'),
		);
	}
	...
	public function getProviderAskAnswer($language)
	{
		$criteria=new CDbCriteria;
