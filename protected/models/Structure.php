...
//    public $icon=array('class'=>'icon-module-small-structure','url'=>'#');
	...
	public function rules()
	{
		...
		return array(
			...
			array('seo_description, text, layout', 'safe', 'on'=>'insert,update'),
            array('item_file', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, lft, rgt, level, root, language_id, seo_title, seo_keywords, seo_description, title, name, text, layout, meta_robots_index, meta_robots_follow, sitemap, redirect, ping, create_time, update_time, author_id, system, status', 'safe', 'on'=>'search'),
		);
	}
