...
class GalleryImages extends Model
{
	...
	public function rules()
	{
        ...
        return array(
            ...
            array('sort, item_file, seo_description, description, author_id','safe'),
    ...
    public function behaviors()
    {
        return array(
            ...
            'ImageBehavior'=>array(
                ...
                'sizes'=>array('big'=>array(isset($this->parent->big_width) ?: 160, isset($this->parent->big_width) ?: 160), 'small'=>array(isset($this->parent->small_width) ?: 160, isset($this->parent->small_width) ?: 160)),
                'quality'=>100
            ),
        );
    }
