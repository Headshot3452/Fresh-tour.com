...
class CatalogTree extends Model
{
	...
	public function rules()
	{
		...
		return array(
            ...
            array('seo_description, item_file, text, map, preview, popular, capital, language, currency, difference, viza, viza_info, country_near, info', 'safe'),
    ...
    public function behaviors()
    {
        return array(
            ...
            'ImageBehavior'=>array(
                ...
                'sizes'=>array('small' => array('250', '250'), 'medium' => array('500', '500'), 'original' => array(null, null), 'big' => array('1000', '1000')),
                'quality' => 100
            ),
        );
    }
