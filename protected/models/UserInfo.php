...
class UserInfo extends Model
{
	...
	public function rules()
	{
		...
		return array(
            ...
            array('birth_day, birth_month, birth_year, comment','safe'),
            array('birth','datevalidate','on'=>'insert,update'),
            array('birth', 'unsafe', 'on'=>'settings_user'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, user_id, name, patronymic, last_name, birth, phone, sum, discount, orders_count, status', 'safe', 'on'=>'search'),
		);
	}
