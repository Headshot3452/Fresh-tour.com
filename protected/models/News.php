    ...
    class News extends Model
    {
        ...
        public function rules()
        {
            return array(
                ...
                array('seo_description, preview, text, item_file, time', 'safe', 'on'=>'insert, update'),
                array('seo_title, seo_keywords, seo_description, preview,text, status', 'safe'),
                array('id, language_id, seo_title, seo_keywords, seo_description, title, name, time, preview, text, images, create_time, update_time, author_id, status', 'safe', 'on'=>'search'),
            );
        }
        ...
        public static function getLastNews($limit, $language, $parent_id, $select = 't.`id`, t.`title`, t.`name`, t.`time`, t.`images`, t.`preview`')
        {
            $criteria = new CDbCriteria();
