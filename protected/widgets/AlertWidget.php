<?php
    class AlertWidget extends CWidget
    {
        ...
        protected $_alerts = array(
            ...
            array('type' => 'modalReview', 'render' => 'renderModalReview'), //модальные окна
        );
        ...
        public function renderModalReview($message)
        {
            $settings = array(
                'url' => '#',
                'header' => '',
            ...
            Yii::app()->getClientScript()->registerScript('renderModalReview'.$this->id,' $("#'.$this->id.'").modal("show");');

            echo
            '<div class="modal modalReview" id="'.$this->id.'">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
