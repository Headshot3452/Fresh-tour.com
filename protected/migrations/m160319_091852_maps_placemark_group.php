...
class m160319_091852_maps_placemark_group extends CDbMigration
{
	public function up()
	{
		$this->createTable('maps_placemark_group', array(
		...
		$this->addForeignKey("fk_maps_placemark_maps_placemark_group", "maps_placemark", "group_id", "maps_placemark_group", "id", "CASCADE", "CASCADE");
	}
	...
	public function down()
	{
		...
		$this->dropForeignKey('fk_maps_placemark_maps_placemark_group', 'maps_placemark');
	}
