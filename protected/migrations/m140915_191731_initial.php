<?php
    class m140915_191731_initial extends CDbMigration
    {
        public function up()
        {
            ...
            $this->createIndex('language_id_idx', 'menu', 'language_id' );
            ...
            $this->addForeignKey("fk_menu_language_language_id", "menu", "language_id", "language", "id", "SET NULL", "CASCADE");
        ...
        public function down()
        {
            ...
            $this->dropForeignKey('fk_menu_language_language_id', 'menu');
