<?php
    class BackendController extends Controller
    {
         ...
         *  array(
         *      'action_id'=>array(
         *                  'label'=>, default '' ($this->beforeRender(),$this->getMenuByActionsConfig())
         *                  'parent'=>, ($this->beforeRender())
         *                  'url'=>, default $this->createUrl(action_id) ($this->beforeRender(),$this->getMenuByActionsConfig())
         *                  'description'=>, ($this->getMenuByActionsConfig())
         *                  'title'=>, default 'label' //value in - $this->_pageTitle and $this->_breadcrumbs ($this->beforeRender())
         *                  'active'=>, default action_id==$active_action(Yii::app()->controller->action->id), ($this->getMenuByActionsConfig())
         *                  'type'=>,string example:'user,company' ($this->getMenuByActionsConfig())
         *              ),
         *  );
         */
    ...
    //    public $defaultAction='list';
        ...
        {
            return array(
                'main_orders'=>array('label'=>Yii::t('app','Work with clients'), 'url'=>array('orders/index')),
                'main_catalog'=>array('label'=>Yii::t('app','Catalog'), 'url'=>array('catalog/index')),
                'main_modules'=>array('label'=>Yii::t('app','Site management'), 'url'=>array('admin/siteManagement')),
                'main_settings'=>array('label'=>Yii::t('app','Global settings'), 'url'=>array('settings/index')),
            );
        }
